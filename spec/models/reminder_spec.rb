...
describe Reminder do
  ...
  context "Destroing" do
    ...
    it "deletes reminder" do
      expect { reminder.reload }.to raise_error
    end

    it "deletes dependent project_checks" do
      expect { project_check.reload }.to raise_error
    end

    it "deletes dependent check_assignments" do
      expect { check_assignment.reload }.to raise_error
    end

    it "deletes dependent skills" do
      expect { skill.reload }.to raise_error
    end
  end
end
